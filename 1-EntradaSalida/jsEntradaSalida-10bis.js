...
function mostrarAumento() {
	...
	//calculo el descuento solicitando por prompt el porcentaje
	coefDescuento = parseInt(prompt("Ingrese el porcentaje a descontar: "));
	descuento = importe * coefDescuento / 100;
